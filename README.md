...
<a href="https://star-history.dera.page/#xguot/difi&Date">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://star-history.dera.page/svg?repos=xguot/difi&type=Date&theme=dark" />
      <source media="(prefers-color-scheme: light)" srcset="https://star-history.dera.page/svg?repos=xguot/difi&type=Date" />
      <img alt="Star History Chart" src="https://star-history.dera.page/svg?repos=xguot/difi&type=Date" />
    </picture>
  </a>
</div>
